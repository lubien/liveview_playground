defmodule LiveviewPlaygroundWeb do
  ...
  #       formats: [:html, :json],
  #       layouts: [html: LiveviewPlaygroundWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {LiveviewPlayground.Layout, :live}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: LiveviewPlaygroundWeb.Router,
        statics: LiveviewPlaygroundWeb.static_paths()
    end
  end
